...
st.write(''' ## Accident ayant impliqué ''', implique.Nombre[0], implique.type[0][0].lower()+'s',''' et ''', implique.Nombre[1], implique.type[1][0].lower())

# st.write(df1)
annee_accid = df1['Date'].dt.year[0]
df3['age'] = annee_accid - df3['an_nais']
df3.insert(0, 'age', df3.pop('age'), allow_duplicates=False)

st.subheader("Gravité de l'accident en fonction de l'age")
# grav_par_age = df3
fig = plt.figure(figsize = (10, 5)) 
sns.boxplot(x='age',  y='grav', hue='sexe', data=df3)
sns.stripplot(x="age", y='grav', hue='sexe', data=df3)
